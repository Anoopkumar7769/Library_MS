...
namespace Library_MS.Controllers
{
    public class BookController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,bname,cat_id,a_id,contents,pages,edition,p_id")] book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,bname,cat_id,a_id,contents,pages,edition,p_id")] book book)
        {
            if (ModelState.IsValid)
            {
